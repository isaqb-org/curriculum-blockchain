...
<<<
:sectnums:
include::01-module-basics/00-structure.adoc[{include_configuration}]

<<<
include::02-module-contracts/00-structure.adoc[{include_configuration}]

<<<
include::03-module-usecases/00-structure.adoc[{include_configuration}]

<<<
include::04-module-permissioned/00-structure.adoc[{include_configuration}]

<<<
include::05-module-architecture/00-structure.adoc[{include_configuration}]
