...
<<<
:sectnums:
include::01-module-basics/00-basics.adoc[{include_configuration}]

<<<
include::02-module-contracts/00-contracts.adoc[{include_configuration}]

<<<
include::03-module-usecases/00-usecases.adoc[{include_configuration}]

<<<
include::04-module-permissioned/00-permissioned.adoc[{include_configuration}]

<<<
include::05-module-architecture/00-architecture.adoc[{include_configuration}]

<<<
include::06-module-example/00-example.adoc[{include_configuration}]
